...
const playwrightCode = defineTabTool({
    ...
    schema: {
        ...
        description: 'Execute arbitrary Playwright code directly. This allows for advanced automation tasks that are not covered by other tools.',
    ...
    handle: async (tab, params, response) => {
        ...
        try {
            ...
            response.addResult(`Error: ${error.message}`);
        }
    },
});
